        ...
        <div class="container">
          <div class="row">
            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12 mb">
              <a href="<?php echo ($lang == 'ru') ? '/': '/' . $lang . '/' ?>maps?orgId=all" class="box" :class="[isBoxActive == 0 ? 'boxActive' : 'box']" style="background: #417c96;"><?php echo $langArray['everybody'] ?></a>
            </div>
            <?php foreach ($array as $item) : ?>
              <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12 mb">
                <a href="<?php echo ($lang == 'ru') ? '/': '/' . $lang . '/' ?>maps?orgId=<?php echo $item['Id'] ?>" class="box" :class="[isBoxActive == <?php echo $item['Id'] ?> ? 'boxActive' : 'box']" style="background: <?php echo $item['Background'] ?>; color: <?php echo $item['Color'] ?>;"><?php echo $item['Name'] ?></a>
              </div>
            <?php endforeach; ?>
            <div class="col-xl-12">
              <div id="map">
