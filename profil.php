...
<head>
  ...
  <meta name="description" content="Данный сайт помогает вам найти услугу для онлайн регистрации на платформу | Профиль">
    ...
    <div class="main">
      ...
      <div class="content">
        <ul class="container breadcrumbs">
          ...
          <li class="breadcrumbs__item">
            <div class="breadcrumbs__link"><?php echo $langArray['profile'] ?></div>
          </li>
        </ul>
      </div>
          ...
          <div class="profil__list">
            ...
            <div v-else class="list" v-for="item in eticketInfos" :key="item.index">
              ...
              <div v-if="show === item.Id" class="list__content">
                ...
                <!-- <a @click.prevent="deleteTicket(item.number, item.deviceId, item.deviceType, item.api)" href="" class="list__link"><?php echo $langArray['deleteBtnET'] ?></a> -->
          ...
          <div class="profil__list">
            ...
            <div v-else class="list" v-for="item in bookingInfos" :key="item.index">
              ...
              <div v-if="show === item.Id" class="list__content">
                ...
                <a @click.prevent="deleteTicket(item.Id)" href="" class="list__link"><?php echo $langArray['deleteBtnET'] ?></a>
                <!-- <a @click.prevent="deleteBooking(item.number, item.startDate, item.api, item.clientId)" href="" class="list__link"><?php echo $langArray['deleteBtnET'] ?></a> -->
              </div>
              <transition name="fade">
                <div v-if="isActiveToolTipId == item.Id" class="list__tooltip">
                  <p><?php echo $langArray['deteleText'] ?></p>
